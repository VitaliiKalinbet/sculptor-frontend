...
// const dateNows = moment('2019-04-19T13:27:17.187Z').format('ddd-mm-YYYY');
// const nexDay = moment(new Date(dateNows)).add(1, 'days');
// console.log(moment(nexDay).format('ddd-mm-YYYY'));
...
class Statistics extends Component {
  ...
  mapper = data => {
    ...
    // console.log(date);
    console.log(new Date(date[0].date).getTime());
  };
  ...
  filterByDone = arr => {
    ...
    console.log(isDone);
    console.log(this.filtredDataByDay(isDone));
  };
  ...
  filtredDataByDay = arr => {
    ...
    if (arr.length) {
      arr.map(el => {
        console.log(this.getDay(el.date));
